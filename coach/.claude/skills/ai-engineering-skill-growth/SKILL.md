---
name: ai-engineering-skill-growth
...
```
Analyze my AI engineering skill growth from my recent chats
```
...
When a user requests analysis of their AI engineering skill growth or coding patterns from recent work:
...
4. **Generate Report**
   ...
   ```markdown
   # Your AI Engineering Skill Growth Report
